...
class DataServerModel(db.Model):
    ...
    ceph_access_key = Column(String(128), nullable=True)
    ceph_secret_key = Column(String(128), nullable=True)
    ceph_host = Column(String(512), nullable=True)
    ceph_port = Column(Integer, nullable=True)
    ceph_is_secure = Column(Boolean, nullable=True)
    ceph_bucket_name = Column(String(128), nullable=True)
    aws_access_key = Column(String(128), nullable=True)
    aws_secret_key = Column(String(128), nullable=True)
    aws_bucket_name = Column(String(128), nullable=True)
    # TODO: GCP
    # TODO: PV
